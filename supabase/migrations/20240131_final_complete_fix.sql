...
-- 4. 重新创建 is_current_user_admin 函数
...
SELECT 
  ...
  is_admin('76443a23-7734-4500-9cd2-89d685eba7d3'::uuid) as result
UNION ALL
SELECT 
...
UNION ALL
SELECT 
  'auth_is_admin test' as test_name,
  auth_is_admin() as result;