...
-- 6. 为 api_key_pool 创建生产级别的 RLS 策略
...
-- 13. 添加你作为第一个管理员（使用你的 user_id）
-- 注意：需要先获取你的 user_id
DO $$
DECLARE
  admin_id uuid;
BEGIN
  -- 获取 jackwwg@gmail.com 的 user_id
  ...
  IF admin_id IS NOT NULL THEN
    ...
    RAISE NOTICE 'Admin user created/confirmed for jackwwg@gmail.com';
  ELSE
    RAISE NOTICE 'User jackwwg@gmail.com not found';
  END IF;
END $$;